  ...
  <div class="filter-wrapper">
    ...
    <div class="filter1">
      <template v-for="item in filterTable.campus">
        <span v-if="!item.selected" class="text-tag" @click="applyFilter('campus', item.value)">
          {{ item.label }}
        </span>
        <el-tag v-else class="filter-tag" closable @close="removeFilter('campus', item.value)">
          {{ item.label }}
        </el-tag>
      </template>
    </div>
    ...
    <div class="filter2">
      <template v-for="item in filterTable.category">
        <span v-if="!item.selected" class="text-tag" @click="applyFilter('category', item.value)">
          {{ item.label }}
        </span>
        <el-tag v-else class="filter-tag" closable @close="removeFilter('category', item.value)">
          {{ item.label }}
        </el-tag>
      </template>
    </div>
    ...
    <div class="filter3">
      <template v-for="item in filterTable.onShelfTime">
        <span v-if="!item.selected" class="text-tag" @click="applyFilter('onShelfTime', item.value)">
          {{ item.label }}
        </span>
        <el-tag v-else class="filter-tag" closable @close="removeFilter('onShelfTime', item.value)">
          {{ item.label }}
        </el-tag>
      </template>
    </div>
    ...
    <div class="filter5">
      <template v-for="item in filterTable.score">
        <span v-if="!item.selected" class="text-tag" @click="applyFilter('score', item.value)">
          {{ item.label }}
        </span>
        <el-tag v-else class="filter-tag" closable @close="removeFilter('score', item.value)">
          {{ item.label }}
        </el-tag>
      </template>
    </div>
