...
<div id="name">
  ...
  <el-container class="sec-container">
    <el-row>
      <el-button 
        type="text" 
        size="small" class="keywords" @click="jumpKeyWord('高数第七版')">高数第七版</el-button>
      <el-button type="text" size="small" class="keywords" @click="jumpKeyWord('大红袍茶叶')">大红袍茶叶</el-button>
      <el-button type="text" size="small" class="keywords" @click="jumpKeyWord('收音机')">四六级收音机</el-button>
      <el-button type="text" size="small" class="keywords" @click="jumpKeyWord('羽毛球拍')">羽毛球拍</el-button>
      <el-button type="text" size="small" class="keywords" @click="jumpKeyWord('空气净化器')">空气净化器</el-button>
      <el-button type="text" size="small" class="keywords" @click="jumpKeyWord('雷蛇鼠标')">雷蛇鼠标</el-button>
      <el-button type="text" size="small" class="keywords" @click="jumpKeyWord('机械键盘')">机械键盘</el-button>
    </el-row>
  </el-container>
  <div class="gap"/>
  <el-container class="thr-container">
    <el-row>
  ...
  <el-container class="for-container">
    <el-row>
      <el-card 
        :body-style="{padding: '0px 0px 0px 0px'}" 
        :style="bg" 
        class="card">
        <span class="winter-label">冬季特价</span><br/>
      ...
      <el-card 
        ...
        <el-avatar 
          ...
          >LogIn</el-avatar><br/>
        <span class="hello">Hi! &nbsp;&nbsp;Please log in!</span>
        <el-row>
          <el-col :span="8">
